...
$("body").on('dblclick', '#patients-in-hospital > tbody > tr', function() {
      var PatientsNumber = $(this).children('td')[0];
      PatientsNumber = PatientsNumber.textContent;
      window.location.href = URL + "/app/patient/" + PatientsNumber;
});
